...
public:
	LegalMovesGenerator();
	std::vector<Move> get_legal_moves_for_piece(Board test_board, PieceName piece_name, BoardPos pos) const;
	std::vector<Move> get_legal_moves_for_side(Board test_board, PieceColor side) const;
